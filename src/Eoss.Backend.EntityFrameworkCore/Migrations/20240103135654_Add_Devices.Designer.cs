...
namespace Eoss.Backend.Migrations
{
    ...
    [Migration("20240103135654_Add_Devices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eoss.Backend.Entities.InstallationParams", b =>
                {
                    ...
                    b.Property<double>("AngleToXAxis")
                        .HasColumnType("double");

                    b.Property<double>("AngleToYAxis")
                        .HasColumnType("double");

                    b.Property<double>("AngleToZAxis")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("Eoss.Backend.Entities.PtzParams", b =>
                {
                    ...
                    b.Property<double>("HomePanToNorth")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Eoss.Backend.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Eoss.Backend.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Eoss.Backend.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Eoss.Backend.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Eoss.Backend.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Eoss.Backend.Entities.Profile", b =>
                {
                    b.HasOne("Eoss.Backend.Entities.Device", null)
                        .WithMany("Profiles")
